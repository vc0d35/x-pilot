...
| app tools      | main, app services           | `xpilot_search_history`, `xpilot_save_article_pdf`, `xpilot_list_library`, `xpilot_schedule_task`, `xpilot_read_page_styles`, `xpilot_write_page_styles`, `xpilot_list_selectors`, `xpilot_test_selector`, `xpilot_set_selector`, `xpilot_reset_selector` |
