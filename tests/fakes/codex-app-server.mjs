...
rl.on('line', async (line) => {
  ...
  if (method === 'initialize')
    return out({ jsonrpc: '2.0', id, result: { userAgent: 'fake/1', codexHome: '/tmp', platformFamily: 'unix', platformOs: 'macos' } });
  ...
  if (method === 'turn/start') {
    ...
    if (userText.includes('DIE')) {
      out({
        ...
        params: { threadId, turnId, itemId: 'cmd-die', command: 'ls', cwd: '/tmp' },
      });
      ...
      out({
        ...
        params: { threadId, turnId, itemId: 'cmd-die', questions: [] },
      });
      return;
    }
    ...
    if (userText.includes('APPROVE')) {
      out({
        ...
        id: 'req-approve',
        method: 'item/commandExecution/requestApproval',
        params: { threadId, turnId, itemId: 'cmd-1', command: 'ls', cwd: '/tmp' },
      });
    ...
    out({
      jsonrpc: '2.0',
      method: 'item/started',
      params: { threadId, turnId, startedAtMs: 0, item: { type: 'reasoning', id: 'r-1', summary: [], content: [] } },
    });
    out({
      jsonrpc: '2.0',
      method: 'item/reasoning/summaryTextDelta',
      params: { threadId, turnId, itemId: 'r-1', delta: 'Need the page ', summaryIndex: 0 },
    });
    out({
      jsonrpc: '2.0',
      method: 'item/reasoning/summaryTextDelta',
      params: { threadId, turnId, itemId: 'r-1', delta: 'state first.', summaryIndex: 0 },
    });
    out({
      jsonrpc: '2.0',
      ...
      params: {
        ...
        turnId,
        completedAtMs: 0,
        item: { type: 'reasoning', id: 'r-1', summary: ['Need the page state first.'], content: [] },
      },
    });
    out({
      jsonrpc: '2.0',
      ...
      params: {
        ...
        turnId,
        startedAtMs: 0,
        item: { type: 'agentMessage', id: 'c-1', text: '', phase: 'commentary', memoryCitation: null, delivery: null, questions: null },
      },
    });
    ...
    const ws = {
      type: 'webSearch',
      id: 'ws-1',
      query: 'electron latest version',
      action: { type: 'search', query: null, queries: ['electron latest version', 'electron releases'] },
    };
    ...
    out({
      ...
      params: { threadId, turnId, callId: 'call-1', namespace: null, tool: 'x_get_page_state', arguments: {} },
    });
    return;
  }
  ...
  if (id === 'req-input') {
    out({
      ...
      params: {
        ...
        item: {
          type: 'agentMessage',
          id: 'msg-3',
          text: 'input-reply=' + JSON.stringify(msg.error ?? msg.result ?? null),
          phase: null,
          memoryCitation: null,
          delivery: null,
          questions: null,
    ...
    out({
      ...
      params: { threadId, turn: { id: 'turn-1', items: [], status: 'completed', error: null } },
    });
    return;
  }
  if (id === 'req-1') {
    ...
    out({
      ...
      params: {
        ...
        item: {
          ...
          arguments: {},
          status: 'completed',
          contentItems: msg.result.contentItems,
    ...
    out({
      ...
      params: {
        ...
        turnId: 'turn-1',
        startedAtMs: 0,
        item: { type: 'agentMessage', id: 'msg-1', text: '', phase: 'final_answer', memoryCitation: null, delivery: null, questions: null },
      },
    });
    out({
      jsonrpc: '2.0',
      method: 'item/agentMessage/delta',
      params: { threadId, turnId: 'turn-1', itemId: 'msg-1', delta: 'You are on: ' },
    });
    ...
    out({
      ...
      params: {
        ...
        item: {
          type: 'agentMessage',
          id: 'msg-2',
          text: 'decision=' + msg.result.decision,
          phase: null,
          memoryCitation: null,
          delivery: null,
          questions: null,
