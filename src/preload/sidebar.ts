...
const api: XPilotApi = {
  ...
  pageStylesPath: () => ipcRenderer.invoke(IPC.pageStylesPath),
  openPageStyles: () => ipcRenderer.invoke(IPC.pageStylesOpen),
  resetPageStyles: () => ipcRenderer.invoke(IPC.pageStylesReset),
  selectorsInfo: () => ipcRenderer.invoke(IPC.selectorsInfo),
  openSelectors: () => ipcRenderer.invoke(IPC.selectorsOpen),
  resetSelectors: () => ipcRenderer.invoke(IPC.selectorsReset),
