...
const api: XPilotApi = {
  ...
  listModels: (provider) => ipcRenderer.invoke(IPC.agentListModels, { provider }),
  setProvider: (provider) => ipcRenderer.invoke(IPC.agentSetProvider, { provider }),
  probeProvider: (provider) => ipcRenderer.invoke(IPC.agentProbeProvider, { provider }),
  ...
  startHandleDrag: (grabX, grabY) => ipcRenderer.invoke(IPC.handleDragStart, { grabX, grabY }),
  moveHandleDrag: (x, y) => ipcRenderer.invoke(IPC.handleDragMove, { x, y }),
  endHandleDrag: (x, y) => ipcRenderer.invoke(IPC.handleDragEnd, { x, y }),
  cancelHandleDrag: () => ipcRenderer.invoke(IPC.handleDragCancel),
  ...
  onHandleDrag: subscribe(IPC.handleDragging),
