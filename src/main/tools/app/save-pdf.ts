...
export const savePdf = defineTool({
  ...
  description:
    "Saves a post, thread, or X Article as a PDF in the user's library folder for reading later. Returns the file path. Renders in a hidden window; the visible page is not disturbed.",
