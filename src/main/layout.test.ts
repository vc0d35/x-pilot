...
import { computeLayout, HANDLE_HEIGHT, HANDLE_INSET, HANDLE_WIDTH, SIDEBAR_WIDTH } from './layout';
...
describe('computeLayout', () => {
  ...
  it('gives the whole window to the X view and floats a handle top-right when collapsed', () => {
    ...
    expect(l.sidebar).toEqual({ x: 1500 - HANDLE_WIDTH - HANDLE_INSET, y: HANDLE_INSET, width: HANDLE_WIDTH, height: HANDLE_HEIGHT });
  });
